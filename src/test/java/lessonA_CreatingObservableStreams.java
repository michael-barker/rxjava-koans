...
public class lessonA_CreatingObservableStreams {
  ...
  public void _2_anObservableStreamEmitsThreeMajorEventTypes() {
    ...
    assertThat(count1).isEqualTo(____);
    assertThat(count2).isEqualTo(____);
    assertThat(count3).isEqualTo(____);
  }
  ...
  public void _3_justCreatesAnObservableEmittingItsArguments() {
    ...
    Observable<String> stoogeDataObservable = Observable.just(_____, _____, _____);
  ...
  public void _4_fromCreatesAnObservableThatEmitsEachElementFromAnIterable() {
    List<String> sandwichIngredients = asList(
        "bread (one)",
        "bread (two)",
        "cheese",
        "mayo",
    ...
    assertThat(subscriber.getOnNextEvents()).containsAll(asList(_____));
