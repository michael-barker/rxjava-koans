...
import static util.LessonResources.*;
...
public class lessonC_BooleanLogicAndErrorHandling {
   ...
   */
    ...
    elevatorQueueOne.takeWhile(_______).doOnNext(elevator::addPassenger).subscribe(subscriber);
  ...
  public void _2_AmbStandsForAmbiguousAndTakesTheFirstOfTwoObservablesToEmitData() {
    ...
    Observable.amb(________, ________, ________).subscribe(subscriber);
  ...
  public void _3_checkingEverything() {
    ...
    assertThat(booleanValue).isEqualTo(____);
  }
  ...
  public void _4_challenge_compositionMeansTheSumIsGreaterThanTheParts() {
    ...
    // HINT: Could you use the MathObservable, with one of the operators you have learned about already to accomplish a
    // result of 19?
  ...
  public void _5_onErrorIsCalledWhenErrorsOccur() {
    ...
    Observable.just(arrayOne, arrayTwo, arrayThree).map(strings -> {
      ...
      return strings;
    }).doOnError(oops -> ______ = oops).subscribe(subscriber);
  ...
  public void _6_retryCanAttemptAnOperationWhichFailsMultipleTimesInTheHopesThatItMaySucceed() {
    ...
    networkRequestObservable.retry(____).subscribe(subscriber);
  ...
  public void _7_combineLatestTakesTheLastEventsOfASetOfObservablesAndCombinesThem() {
    ...
    Observable<Boolean> lockIsPickedObservable =
        Observable.combineLatest(__________, __________, __________, combineTumblerStatesFunction)
            .takeUntil(unlocked -> unlocked == true).last();
