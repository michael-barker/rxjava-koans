...
public class lessonB_Solutions {
  ...
  public void _1_mapAppliesAFunctionToEachItemAndEmitsDataOnTheOtherSide() {
    ...
    assertThat(subscriber.getOnNextEvents()).contains("k3w1");
    assertThat(subscriber.getOnNextEvents()).contains("133t");
    assertThat(subscriber.getOnNextEvents()).contains("sp3ak");
  }
   ...
   */
    ...
    assertThat(subscriber.getOnNextEvents()).hasSize(11);
  }
  ...
  public void _2_C_flatMapUnwrapsOneLevelOfNestingInAnObservableStream() {
    ...
    assertThat(subscriber.getOnNextEvents()).hasSize(7);
  }
  ...
  public void _3_theReduceOperatorAccumulatesValuesAndEmitsTheResult() {
    ...
    assertThat(testSubscriber.getOnNextEvents().get(0)).isEqualTo(350);
  }
  ...
  public void _5_composableFunctions() {
    ...
    assertThat(string1).isEqualTo("123456");
    assertThat(string2).isEqualTo("246");
    assertThat(string3).isEqualTo("112233445566");
  }
